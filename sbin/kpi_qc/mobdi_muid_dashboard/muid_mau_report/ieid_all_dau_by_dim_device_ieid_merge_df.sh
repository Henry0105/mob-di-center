...
select
ieid_history,ieid_yearhalf,ieid_history-ieid_history_yesterday as ieid_history_dau,ieid_yearhalf-ieid_yearhalf_yesterday as ieid_yearhalf_dau
from
(
select
count(*) as ieid_history,sum(if(ieid_ltm >= $yearhalf_days,1,0)) as ieid_yearhalf
from
(
...
join
(select ieid_history as ieid_history_yesterday,ieid_yearhalf as ieid_yearhalf_yesterday
