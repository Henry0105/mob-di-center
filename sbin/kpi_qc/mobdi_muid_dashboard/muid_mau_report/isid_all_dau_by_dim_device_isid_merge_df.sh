...
select
isid_history,isid_yearhalf,isid_history-isid_history_yesterday as isid_history_dau,isid_yearhalf-isid_yearhalf_yesterday as isid_yearhalf_dau
from
(
select
count(*) as isid_history,sum(if(isid_ltm >= $yearhalf_days,1,0)) as isid_yearhalf
from
(
...
join
(select isid_history as isid_history_yesterday,isid_yearhalf as isid_yearhalf_yesterday
