...
insert overwrite table mobdi_muid_dashboard.muid_historyfull_applist_ieid_oiid_pid_full partition (day=${day},full_type='day')
select 
a.device,
...
insert overwrite table mobdi_muid_dashboard.muid_historyfull_applist_ieid_oiid_pid_report partition(day=$day,full_type='day')
...
where day=$day and full_type='day'
)a
