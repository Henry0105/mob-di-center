...
# output
#dim_mcid_attribute_full_par_sec=dm_mobdi_mapping.dim_mcid_attribute_full_par_sec

# view
#dim_mcid_attribute_full_par_secview=dm_mobdi_mapping.dim_mcid_attribute_full_par_secview
