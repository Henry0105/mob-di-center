...
insert_day=$1
source_table="auto_location_info"
...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_auto_location_info_sec_di/day=${insert_day}"
...
insert overwrite table $device_location_daily_incr partition (day='$insert_day', source_table='auto_location_info')
...
from
  ...
  (select * from $dwd_device_location_di
   ...
   and source_table='auto_location_info') t2
  on t1.muid = t2.muid
;
"
