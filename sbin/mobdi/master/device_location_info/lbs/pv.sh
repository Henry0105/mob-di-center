...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_pv_sec_di/day=${insert_day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_pv_sec_di/day=${plus_1day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_pv_sec_di/day=${plus_2day}"
...
insert overwrite table $device_location_daily_incr partition (day='$insert_day', source_table='pv')
...
and from_unixtime(unix_timestamp(clienttime), 'yyyyMMdd') = '$insert_day' --取clienttime转换为当日的数据
