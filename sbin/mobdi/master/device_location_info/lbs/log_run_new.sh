...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_log_run_new_di/day=${insert_day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_log_run_new_di/day=${plus_1day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_log_run_new_di/day=${plus_2day}"
...
insert overwrite table $device_location_daily_incr partition (day='$insert_day', source_table='log_run_new')
...
and source_table='log_run_new') t2
on t1.muid = t2.muid
;
"
