...
#dim_geohash6_china_area_mapping_par=dm_sdk_mapping.dim_geohash6_china_area_mapping_par
...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/$auto_location_db.db/$auto_location_tb/day=${day}"
# ##########################################
