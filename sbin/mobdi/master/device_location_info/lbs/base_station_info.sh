...
insert_day=$1
source_table="base_station_info"
...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_base_station_info_sec_di/day=${plus_1day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_base_station_info_sec_di/day=${plus_2day}"
...
insert overwrite table $device_location_daily_incr partition (day='$insert_day', source_table='base_station_info')
...
where day between '$plus_1day' and '$plus_2day'  --取开始日期起3天范围
...
and source_table='base_station_info') t2
on t1.muid = t2.muid
;
"
