...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_location_info_sec_di/day=${insert_day}"
...
insert overwrite table $device_location_daily_incr partition (day='$insert_day', source_table='location_info')
...
and source_table='location_info') t2
on t1.muid = t2.muid
;
"