...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_t_location_sec_di/day=${insert_day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_t_location_sec_di/day=${plus_1day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/dm_mobdi_master.db/dwd_t_location_sec_di/day=${plus_2day}"
...
insert overwrite table $device_location_daily_incr partition (day='$insert_day', source_table='t_location')
select t1.muid as device,duid,lat,lon,time,processtime,country,province,city,area,street,plat,network,type,data_source,
orig_note1,orig_note2,accuracy,apppkg,orig_note3,ga_abnormal_flag,t1.muid
from
(select
...
and source_table='t_location') t2
on t1.muid = t2.muid
;
"
