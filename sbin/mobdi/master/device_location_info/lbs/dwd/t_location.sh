...
t_location_db=$(echo $dwd_t_location_sec_di|awk -F '.' '{print $1}')
t_location_tb=$(echo $dwd_t_location_sec_di|awk -F '.' '{print $2}')
...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/$t_location_db.db/$t_location_tb/day=${plus_1day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/$t_location_db.db/$t_location_tb/day=${plus_2day}"
# ##########################################
