...
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/$base_location_db.db/$base_location_tb/day=${plus_1day}"
CHECK_DATA "hdfs://ShareSdkHadoop/user/hive/warehouse/$base_location_db.db/$base_location_tb/day=${plus_2day}"
# ##########################################
