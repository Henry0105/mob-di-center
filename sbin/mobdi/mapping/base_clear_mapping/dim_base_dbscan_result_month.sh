...
mid_dbscan_data_process_month_step3=${dm_mobdi_tmp}.mid_dbscan_data_process_month_step3
mid_dbscan_data_process_month_step4=${dm_mobdi_tmp}.mid_dbscan_data_process_month_step4
mid_dbscan_data_final_month_step1=${dm_mobdi_tmp}.mid_dbscan_data_final_month_step1
mid_dbscan_data_final_month_step2=${dm_mobdi_tmp}.mid_dbscan_data_final_month_step2
mid_dbscan_data_final_month_step3=${dm_mobdi_tmp}.mid_dbscan_data_final_month_step3
mid_dbscan_data_result_month=${dm_mobdi_tmp}.mid_dbscan_data_result_month
