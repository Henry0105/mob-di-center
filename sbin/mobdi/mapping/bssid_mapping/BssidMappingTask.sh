...
#input calculate_bssid_mapping_base_info
#ouput
speed_abnormal_device_info_for_mapping=dw_mobdi_tmp.speed_abnormal_device_info_for_mapping
#input speed_abnormal_device_info_for_mapping calculate_bssid_mapping_base_info
#output
...
#input calculate_bssid_mapping_base_info_except_abnormal_data
#output
bssid_from_gps_par=dw_mobdi_tmp.bssid_from_gps_par
#input bssid_from_gps_par
#output
...
#input bssid_finaltable_gps_cnt3_pre_allinfo_par bssid_finaltable_gps_cnt3_pre_allinfo_maxday_maxcnt_par
#output
bssid_finaltable_gps_cnt3_par=dw_mobdi_tmp.bssid_finaltable_gps_cnt3_par
#input bssid_finaltable_gps_cnt3_pre_allinfo_maxday_par bssid_finaltable_gps_cnt3_pre_allinfo_maxday_maxcnt_par
#output
bssid_finaltable_gps_cnt3_notsure_par=dw_mobdi_tmp.bssid_finaltable_gps_cnt3_notsure_par
#input bssid_finaltable_gps_cnt3_notsure_par
#output
...
#input bssid_finaltable_gps_cnt3_pre_allinfo_par bssid_finaltable_gps_cnt3_sure_pre_par
#output
...
#input bssid_finaltable_gps_cnt3_par bssid_strangetable_gps_cnt2_par
#output
bssid_strangetable_gps_par=dw_mobdi_tmp.bssid_strangetable_gps_par
#input  bssid_finaltable_gps_cnt1_par bssid_finaltable_gps_cnt2_par  bssid_finaltable_gps_cnt3_par
#output
bssid_finaltable_gps_par=dw_mobdi_tmp.bssid_finaltable_gps_par
#input bssid_finaltable_gps_par
#output
bssid_finaltable_gps_new_par=dw_mobdi_tmp.bssid_finaltable_gps_new_par
#input bssid_finaltable_gps_new_par
bssid_exchange=dw_mobdi_source.bssid_exchange
#output
bssid_finaltable_par=dw_mobdi_tmp.bssid_finaltable_par
#input bssid_finaltable_par
#output
bssid_finaltable_addgeohash8_par=dw_mobdi_tmp.bssid_finaltable_addgeohash8_par
#input dm_sdk_mapping.geohash8_lbs_info_mapping_par #dm_sdk_mapping.geohash6_area_mapping_par #bssid_finaltable_addgeohash8_par
#output
bssid_finaltable_addgeohash8_addlocation_par=dw_mobdi_tmp.bssid_finaltable_addgeohash8_addlocation_par
#input bssid_finaltable_addgeohash8_addlocation_par dm_mobdi_mapping.dim_bssid_type_all_mf
#output dm_mobdi_mapping.dim_mapping_bssid_location_mf
#input dm_mobdi_master.dwd_log_wifi_info_sec_di
#output dm_mobdi_mapping.bssid_ssid_mapping_par
