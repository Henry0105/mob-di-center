...
tmpdb=$dm_mobdi_tmp
#中间库
shopping_mall_poi_info=$tmpdb.shopping_mall_poi_info
shopping_mall_poi_and_bssid_connect_info=$tmpdb.shopping_mall_poi_and_bssid_connect_info
ssid_match_data_prepare=$tmpdb.ssid_match_data_prepare
shopping_mall_poi_and_ssid_connect_count_info=$tmpdb.shopping_mall_poi_and_ssid_connect_count_info
shopping_mall_ssid_calculate_base_info=$tmpdb.shopping_mall_ssid_calculate_base_info
shopping_mall_name_match_ssid_info=$tmpdb.shopping_mall_name_match_ssid_info
shopping_mall_ssid_cn_match=$tmpdb.shopping_mall_ssid_cn_match
city_name_combine_area_name=$tmpdb.city_name_combine_area_name
shopping_mall_ssid_3number_match=$tmpdb.shopping_mall_ssid_3number_match
shopping_mall_ssid_2number_match=$tmpdb.shopping_mall_ssid_2number_match
shopping_mall_ssid_name_en_match=$tmpdb.shopping_mall_ssid_name_en_match
shopping_mall_ssid_famous_en_match=$tmpdb.shopping_mall_ssid_famous_en_match
shopping_mall_ssid_ffan_en_match=$tmpdb.shopping_mall_ssid_ffan_en_match
shopping_mall_ssid_rude_match=$tmpdb.shopping_mall_ssid_rude_match
shopping_mall_ssid_match_merge_all_conditions=$tmpdb.shopping_mall_ssid_match_merge_all_conditions
shopping_mall_split_ssid_pinyin_match=$tmpdb.shopping_mall_split_ssid_pinyin_match
shopping_mall_split_ssid_pinyin_short_match=$tmpdb.shopping_mall_split_ssid_pinyin_short_match
shopping_mall_ssid_pinyin_match=$tmpdb.shopping_mall_ssid_pinyin_match
shopping_mall_ssid_pinyin_short_match=$tmpdb.shopping_mall_ssid_pinyin_short_match
shopping_mall_bssid_remain_1=$tmpdb.shopping_mall_bssid_remain_1
shopping_mall_ssid_match_second_confidence=$tmpdb.shopping_mall_ssid_match_second_confidence
shopping_mall_bssid_remain_2=$tmpdb.shopping_mall_bssid_remain_2
shopping_mall_ssid_match_third_confidence=$tmpdb.shopping_mall_ssid_match_third_confidence
shopping_mall_poi_and_bssid_info=$tmpdb.shopping_mall_poi_and_bssid_info
one_bssid_ssid_with_multiple_shopping_mall_info=$tmpdb.one_bssid_ssid_with_multiple_shopping_mall_info
