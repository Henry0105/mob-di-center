...
insert overwrite table $dim_device_oaid_mapping_di partition (day='$enddate',source='log_device_info_jh')
select
...
insert overwrite table $dim_device_oaid_mapping_di partition (day='$enddate',source='awaken_dfl')
select
    b.device,
    case
