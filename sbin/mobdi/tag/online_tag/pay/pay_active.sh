...
@TableRelation:dm_sdk_mapping.dim_tag_cat_mapping_dmp_par->dm_mobdi_mapping.online_category_mapping|dm_mobdi_mapping.online_category_mapping,rp_mobdi_app.rp_device_active_label_profile->rp_mobdi_app.timewindow_online_profile
'
day=$1
mappingtype=12
computeType=1
