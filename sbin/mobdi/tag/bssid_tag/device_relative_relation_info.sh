...
tmp_relatives_friends_bssid_ssid_location_info=$tmpdb.tmp_relatives_friends_bssid_ssid_location_info
tmp_relatives_friends_bssid_ssid_etlIdentifiedBssid_info=$tmpdb.tmp_relatives_friends_bssid_ssid_etlIdentifiedBssid_info
tmp_relatives_friends_bssid_ssid_clean_info=$tmpdb.tmp_relatives_friends_bssid_ssid_clean_info
tmp_relatives_friends_bssid_device_connectDays_dinstance_info=$tmpdb.tmp_relatives_friends_bssid_device_connectDays_dinstance_info
