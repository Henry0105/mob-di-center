...
/usr/bin/spark2-submit  --executor-memory 15G   \
	...
	/home/dba/mobdi_center/lib/offlineLabel-v0.1.0-jar-with-dependencies.jar  --partition ${day} --pk ifid --filenum 2000 --fields [level:level,cate1:cate1:,] \
	--lbstype 9 --windowtime ${timewindow} --sourcetable $dws_ifid_lbs_poi_ios_sec_di --targetable $timewindow_offline_profile_ios_v2_sec
