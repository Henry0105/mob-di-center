...
/usr/bin/spark2-submit  --executor-memory 15G   \
    ...
    --conf "spark.yarn.executor.memoryOverhead=4096" \
	 ...
	 -g $timewindow_offline_profile_v2
...
insert overwrite table $timewindow_offline_profile_v2 partition(flag=1,day=$day,timewindow=$timewindow)
select device,feature,cnt from $timewindow_offline_profile_v2 where flag=1 and day=$day and timewindow=$timewindow
"