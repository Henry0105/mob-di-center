...
insert overwrite table $timewindow_offline_profile_v2 partition(flag=6,day=$day,timewindow=$timewindow)
select device,feature,cnt from $timewindow_offline_profile_v2 where flag=6 and day=$day and timewindow=$timewindow
"
