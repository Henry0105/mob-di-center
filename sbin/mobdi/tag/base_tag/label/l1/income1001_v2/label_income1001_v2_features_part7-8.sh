...
#mapping_age_app_index0="dm_sdk_mapping.mapping_age_app_index0"
  ...
  (
    ...
    (
      ...
      (
        ...
        where day=GET_LAST_PARTITION('$install_uninstall_year_db','$install_uninstall_year_tb','day') and refine_final_flag=-1
