...
day_before_half_year=$(date -d "${day} -6 month" "+%Y%m%d")
...
age_new_active_days_6="$dm_mobdi_tmp.age_new_active_days_6"
...
insert overwrite table $age_new_active_days_6 partition (day=$day)
select device
    ...
    (
        ...
        from(
                ...
                from(
                    ...
                    where day between $day_before_half_year and $day
...
hive -e "
alter table $age_new_active_days_6 drop partition(day< $day_before_one_month);
"