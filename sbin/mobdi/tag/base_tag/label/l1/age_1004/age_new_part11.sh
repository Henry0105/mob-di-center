...
insertday=${day}_muid
#dim_aginsertday=${day}_muide_app_category_final_new=dim_mobdi_mapping.dim_age_app_category_final_new
...
insert overwrite table $age_new_active_days_1 partition (day=$insertday)
select device
