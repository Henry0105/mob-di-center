...
insert overwrite table $label_l1_apppkg_category_index partition (day = '$day', version = '1003.gender.cate_l1')
...
insert overwrite table $label_l1_apppkg_category_index partition (day = '$day', version = '1003.gender.cate_l2')
select device,index,1.0 as cnt
from
(
  select c.device,d.index
