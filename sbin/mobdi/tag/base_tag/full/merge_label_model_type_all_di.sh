...
select un.device,user_model.gender,user_model.agebin,user_model.car,user_model.married,user_model.edu,user_model.income,
       ...
       user_model.income_1001,user_model.occupation_1001,user_model.consume_level,consume.consume_1001,
       ...
       user_model.agebin_1001_cl,user_model.income_1001_cl,user_model.occupation_1001_cl,user_model.consume_level_cl,user_model.agebin_1002,user_model.agebin_1002_cl,user_model.agebin_1003,user_model.agebin_1003_cl
from
(
  select device
  from
