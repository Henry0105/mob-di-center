...
income_1001_pid_contacts_index=dw_mobdi_md.income_1001_pid_contacts_index_sec   # 加密表
income_1001_pid_contacts_word2vec_index=dw_mobdi_md.income_1001_phone_contacts_word2vec_index  # 需要改表名

modelPath="/dmgroup/dba/modelpath/20200413/gender"
length=7300

#tmp
gender_all_index=dw_mobdi_md.gender_all_index
