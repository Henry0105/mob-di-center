...
/home/dba/mobdi_center/lib/MobDI-spark2-1.0-SNAPSHOT-jar-with-dependencies.jar "$tmp_score_part1" "$tmp_score_part2" "$tmp_score_part3" "$tmp_score_part4" "$tmp_score_part5" "$tmp_score_part6" "$tmp_score_part7" "$tmp_score_part8" "$tmp_score_app2vec" "$modelPath" "$threshold" "$out_put_table" "$day"
