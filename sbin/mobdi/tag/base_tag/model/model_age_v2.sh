...
/home/dba/mobdi_center/lib/MobDI-spark2-1.0-SNAPSHOT-jar-with-dependencies.jar "$modelPath" "$modelPath0" "$modelPath1" "$modelPath2" "$threshold" "$out_put_table" "20200701" "$day" $test_flag
