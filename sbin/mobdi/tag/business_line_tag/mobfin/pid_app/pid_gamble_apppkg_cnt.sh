...
set mapreduce.reduce.java.opts='-Xmx7300m' -XX:+UseG1GC;
...
set mapred.job.name=pid_gamble_apppkg_cnt_1;
...
insert overwrite table $label_l1_anticheat_pid_cnt_sec partition(day = '$day',timewindow = '30',flag = '4')
...
set mapred.tasktracker.reduce.tasks.maximum=24;
set mapreduce.job.reduce.slowstart.completedmaps=0.8;
set mapred.job.name=pid_gamble_apppkg_cnt_2;
...
insert overwrite table $label_l1_anticheat_pid_cnt_sec partition (day = '$day',timewindow = '30',flag = '17')
select a.pid,if(b.device is null,0,b.cnt) as cnt
from
(
    select pid,device
...
set mapred.tasktracker.reduce.tasks.maximum=24;
set mapreduce.job.reduce.slowstart.completedmaps=0.8;
set mapred.job.name=pid_gamble_apppkg_cnt_3;
...
insert overwrite table $label_l1_anticheat_pid_cnt_sec partition (day = '$day',timewindow = '30',flag = '18')
select a.pid,if(b.device is null,0,b.cnt) as cnt
from
(
    select pid,device
