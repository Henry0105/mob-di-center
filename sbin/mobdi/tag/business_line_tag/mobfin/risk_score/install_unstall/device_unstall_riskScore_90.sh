...
#tmp
tmp_anticheat_device_unstall_90days_pre=dw_mobdi_tmp.tmp_anticheat_device_unstall_90days_pre
...
insert overwrite table $tmp_anticheat_device_unstall_90days_pre partition (day = '$day')
...
insert overwrite table $label_l1_anticheat_device_riskscore partition(day = '$day',timewindow = '90',flag='2')
select device,ln(cnt_all/cnt_pkg)/(ln(cnt_all/cnt_pkg)+1) as riskScore
from $tmp_anticheat_device_unstall_90days_pre
where day = '$day';
"

#卸载评分
q1=`hive -e "select percentile(cnt_pkg,0.25) from $tmp_anticheat_device_unstall_90days_pre where day = '$day';"`
q3=`hive -e "select percentile(cnt_pkg,0.75) from $tmp_anticheat_device_unstall_90days_pre where day = '$day';"`
maxValue=`hive -e "select percentile(cnt_pkg,0.99) from $tmp_anticheat_device_unstall_90days_pre where day = '$day';"`
...
insert overwrite table $label_l1_anticheat_device_riskscore partition(day = '$day',timewindow = '90',flag='1')
select device,
case 
