...
/usr/bin/spark2-submit  --executor-memory 15G   \
    ...
    --conf "spark.yarn.executor.memoryOverhead=4096" \
	 ...
	 -t 1 \
	 -w ${timewindow} \
	 -s dm_mobdi_master.sdk_lbs_daily_poi \
	 -g rp_mobdi_app.timewindow_offline_profile_v2
...
insert overwrite table rp_mobdi_app.timewindow_offline_profile_v2 partition(flag=1,day=$day,timewindow=$timewindow)
select device,feature,cnt from rp_mobdi_app.timewindow_offline_profile_v2 where flag=1 and day=$day and timewindow=$timewindow
"