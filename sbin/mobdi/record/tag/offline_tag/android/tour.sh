...
/usr/bin/spark2-submit  --executor-memory 15G   \
	...
	/home/dba/lib/offlineLabel-v0.1.0-jar-with-dependencies.jar  --partition ${day} --pk device --filenum 8000 --fields [level:level,cate1:cate1:,] \
	--lbstype 9 --windowtime ${timewindow} --sourcetable dm_mobdi_master.sdk_lbs_daily_poi --targetable rp_mobdi_app.timewindow_offline_profile_v2
...
insert overwrite table rp_mobdi_app.timewindow_offline_profile_v2 partition(flag=9,day=$day,timewindow=$timewindow)
select device,feature,cnt from rp_mobdi_app.timewindow_offline_profile_v2 where flag=9 and day=$day and timewindow=$timewindow
"