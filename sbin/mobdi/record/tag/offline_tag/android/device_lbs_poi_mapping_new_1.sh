...
@SourceTable:dm_sdk_mapping.poi_config_mapping_par,dm_mobdi_master.device_staying_daily,dw_mobdi_md.lbs_poi_mapping_catering
...
where day=${day} and data_source <> 'pv' and type <> 'ip' and plat = 1 and start_time <= end_time\",
    ...
    \"targetTable\": \"dw_mobdi_md.lbs_poi_mapping_catering\"
}"
...
insert overwrite table dm_mobdi_master.sdk_lbs_daily_poi partition(type,day)
 ...
 from dw_mobdi_md.lbs_poi_mapping_catering a
 inner join 
 (
