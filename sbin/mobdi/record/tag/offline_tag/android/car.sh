...
/usr/bin/spark2-submit  --executor-memory 15G   \
	...
	--sourcetable dm_mobdi_master.sdk_lbs_daily_poi \
	--targetable rp_mobdi_app.timewindow_offline_profile_v2
...
insert overwrite table rp_mobdi_app.timewindow_offline_profile_v2 partition(flag=3,day=$day,timewindow=$timewindow)
select device,feature,cnt from rp_mobdi_app.timewindow_offline_profile_v2 where flag=3 and day=$day and timewindow=$timewindow
"
