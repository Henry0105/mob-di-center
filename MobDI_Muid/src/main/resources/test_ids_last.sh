...
dws_mid_ids_mapping="$tmp_db.dws_mid_ids_mapping"

ids_vertex_par="$tmp_db.duid_vertex_par_ids"
ids_unid_final_mapping="$tmp_db.ids_old_new_unid_mapping_par"

all_vertex_par="$tmp_db.duid_vertex_par_all"
all_unid_final_mapping="$tmp_db.all_old_new_unid_mapping_par"

ieid_unid_tmp="$tmp_db.ieid_unid_tmp"
oiid_unid_tmp="$tmp_db.oiid_unid_tmp"

duid_blacklist="$tmp_db.duid_blacklist"
...
where duid is not null and duid<>'' and day=20211101
) a
